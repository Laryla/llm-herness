import type { Message, Turn } from "@llm-harness/contracts";
...
export function ConversationHistory({ loading, messages, turns }: { loading: boolean; messages: Message[]; turns: Turn[] }) {
